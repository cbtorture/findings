**L2**: List initializer (with 3 elements)
==========================================
...
This test is like that of [L2](l2.md) but that we will use three elements instead:
...
We will be testing a two versions of this same program to account for the two (you
will see that these are the only ones that actually occur, not 3!) possible outcomes
(and also what they _mean_ semantically):

1. `result[0] == 1 && result[1] == 2 && result[2] == 3`
	* This implies left-to-right evaluation
2. `result[0] == 3 && result[1] == 2 && result[2] == 1`
...
### Program 1 (`result[0] == 1 && result[1] == 2 && result[2] == 3`)

Running program: `lists/l2/program_analysis.c`
...
### Program 2 (`result[0] == 3 && result[1] == 2 && result[2] == 1`)

Running program: `lists/l2/program_analysis2.c`
...
Every compiler **always** does left-to-right evaluation.
