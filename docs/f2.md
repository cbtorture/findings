...
**F2** will use a different testing mechanism as simply cloning _F1_ can return results
...
### Program 1 (`orderArray[0] == 3 && orderArray[1] == 2 && orderArray[2] == 1`)
...
### Program 2 (`orderArray[0] == 1 && orderArray[1] == 2 && orderArray[2] == 3`)
...
Expected assertion: `result[0] == 3 && result[1] == 2 && result[2] == 1`
...
|GCC| ['gcc', '-std=c90', '-O0', '-o', '0107ff703d7eef96ab3789af0c9603e6']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `0107ff703d7eef96ab3789af0c9603e6` |
|GCC| ['gcc', '-std=c2x', '-O0', '-o', 'd6dba0f0e2a520ff209e0a1de3f40d1c']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `d6dba0f0e2a520ff209e0a1de3f40d1c` |
|GCC| ['gcc', '-std=c17', '-O0', '-o', '0944285764068a76ecc6fbd53f44a1ec']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `0944285764068a76ecc6fbd53f44a1ec` |
|GCC| ['gcc', '-std=c18', '-O0', '-o', '923e7d926d54da3ec9b3ab52af0dc2e8']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `923e7d926d54da3ec9b3ab52af0dc2e8` |
|GCC| ['gcc', '-std=c11', '-O0', '-o', '9383a9ced9f13f45a746db8f312ec53c']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `9383a9ced9f13f45a746db8f312ec53c` |
|GCC| ['gcc', '-std=c1x', '-O0', '-o', '43083cad79238ec5e7d2f038c4ca7b05']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `43083cad79238ec5e7d2f038c4ca7b05` |
|GCC| ['gcc', '-std=gnu11', '-O0', '-o', '593cc6a1e936396e2dfe44e73f747935']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `593cc6a1e936396e2dfe44e73f747935` |
|GCC| ['gcc', '-std=iso9899:1990', '-O0', '-o', '35b541612d58aeb32c3c35f3b7c0d32e']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `35b541612d58aeb32c3c35f3b7c0d32e` |
|GCC| ['gcc', '-std=iso9899:199409', '-O0', '-o', 'cb502324e6ca21edf23197a033b199f9']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `cb502324e6ca21edf23197a033b199f9` |
|GCC| ['gcc', '-std=gnu89', '-O0', '-o', '1388a6d1ee3a606e51909d7670650200']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `1388a6d1ee3a606e51909d7670650200` |
|GCC| ['gcc', '-std=gnu90', '-O0', '-o', '20699d4f48d67f8bbd2c088358dda93c']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `20699d4f48d67f8bbd2c088358dda93c` |
|GCC| ['gcc', '-std=iso9899:1999', '-O0', '-o', '7086bf496ee0bd00b38d1deb1457a6ed']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `7086bf496ee0bd00b38d1deb1457a6ed` |
|GCC| ['gcc', '-std=gnu99', '-O0', '-o', 'a49d775b9c92e880177902185cd9c66f']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `a49d775b9c92e880177902185cd9c66f` |
|GCC| ['gcc', '-std=iso9899:2011', '-O0', '-o', 'cfcdef135180100186eebe3c34c4d2fb']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `cfcdef135180100186eebe3c34c4d2fb` |
|GCC| ['gcc', '-std=iso9899:2017', '-O0', '-o', 'dae39efc35cfac623901798dd4a7e73c']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `dae39efc35cfac623901798dd4a7e73c` |
|GCC| ['gcc', '-std=gnu11', '-O0', '-o', '593cc6a1e936396e2dfe44e73f747935']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `593cc6a1e936396e2dfe44e73f747935` |
|GCC| ['gcc', '-std=c99', '-O1', '-o', '0522980fe4c84bc84ed7bfdfe4a054c4']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `0522980fe4c84bc84ed7bfdfe4a054c4` |
|GCC| ['gcc', '-std=c9x', '-O1', '-o', '2e353ca5cddbcb785710b1cf68ba5235']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `2e353ca5cddbcb785710b1cf68ba5235` |
|GCC| ['gcc', '-std=c89', '-O1', '-o', '9facf514ce56f87440f01c062a884801']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `9facf514ce56f87440f01c062a884801` |
|GCC| ['gcc', '-std=c90', '-O1', '-o', 'b819fb34bb00376e6191b929bad540d5']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `b819fb34bb00376e6191b929bad540d5` |
|GCC| ['gcc', '-std=c2x', '-O1', '-o', '668814c85e205159dc0d8ec39e14f8e5']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `668814c85e205159dc0d8ec39e14f8e5` |
|GCC| ['gcc', '-std=c17', '-O1', '-o', 'bc7b4762206ad5d80e56169273c9fea2']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `bc7b4762206ad5d80e56169273c9fea2` |
|GCC| ['gcc', '-std=c18', '-O1', '-o', '038b8074010aa1dce694cbfa33040c51']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `038b8074010aa1dce694cbfa33040c51` |
|GCC| ['gcc', '-std=c11', '-O1', '-o', '4a8bdb61c07d15278614327757e4c6a2']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `4a8bdb61c07d15278614327757e4c6a2` |
|GCC| ['gcc', '-std=c1x', '-O1', '-o', '2b2cd7dcc45f21100004d6649dd06377']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `2b2cd7dcc45f21100004d6649dd06377` |
...
|GCC| ['gcc', '-std=c2x', '-O3', '-o', '57c9fb207322afc14608829bc9bee0ad']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ✅️| `57c9fb207322afc14608829bc9bee0ad` |
...
|Clang| ['clang', '-std=gnu90', '-O2', '-o', 'c2155b243784ce512f18a9954db79b69']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `c2155b243784ce512f18a9954db79b69` |
...
|TCC| ['tcc', '-std=c1x', '-O0', '-o', '0d4eb74fc42ac980cf2ca68f1c90a4a4']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `0d4eb74fc42ac980cf2ca68f1c90a4a4` |
...
|TCC| ['tcc', '-std=c2x', '-O2', '-o', '35af2900ec5fe7a10627144018a3471c']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `35af2900ec5fe7a10627144018a3471c` |
...
|TCC| ['tcc', '-std=gnu11', '-O3', '-o', '23534b6f94531ef4c391b5d9fe172686']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `23534b6f94531ef4c391b5d9fe172686` |
|CompCert| ['ccomp', '-O0', '-o', 'd9a473bd80a5549832093b25e8416b88']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `d9a473bd80a5549832093b25e8416b88` |
|CompCert| ['ccomp', '-O1', '-o', 'd0ffe543b7cfb1a5a2cbcc2779390d2d']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `d0ffe543b7cfb1a5a2cbcc2779390d2d` |
|CompCert| ['ccomp', '-O2', '-o', 'dec6f2eab7998be0161f7c23b9444638']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `dec6f2eab7998be0161f7c23b9444638` |
|CompCert| ['ccomp', '-O3', '-o', '96c334b1475a6d6ee71834eb57862ae8']| `result[0] == 3 && result[1] == 2 && result[2] == 1` | ❌️| `96c334b1475a6d6ee71834eb57862ae8` |
